...
contract FlightSuretyApp {
    ...
    */   
	...
	function getAirline(address _airlineAddress) public  returns (string airlineName)
	{
	
	//  airlineName =flightDataContract.getSampleDataAirline(_airlineAddress);
...
contract FlightSuretyData {
 ...
 function pay(address payoutAddress);
	function getSampleDataAirline(address _airlineAddress);
}
